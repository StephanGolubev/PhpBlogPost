...
<header>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <ul class="navbar-nav bd-navbar-nav mr-auto mt-2 mt-lg-0">
      ...
      <li class="nav-item">
        <h3><a class="nav-link" href="pages/breakthrough-club.php">Breakthrough Club</a></h3>
      </li>
      <li class="nav-item">
        <h3><a class="nav-link" href="pages/courses.php">Courses</a></h3>
        </li>
        <li class="nav-item">
        <h3><a class="nav-link" href="pages/blog.php">Blog</a></h3>
      </li>
      <li class="nav-item">
        <h3><a class="nav-link" href="pages/exercises.php">Exercises</a></h3>
        </li>
      <li class="nav-item">
